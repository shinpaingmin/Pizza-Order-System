            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-3 offset-8">
                        <a onclick="javascript:history.back()"><button class="btn bg-dark text-white my-3">List</button></a>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category#update', $category->category_id) }}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror" aria-required="true" aria-invalid="false" placeholder="Seafood..." value="{{ old('categoryName', $category->category_name) }}">
                                </div>
                                @error('categoryName')
